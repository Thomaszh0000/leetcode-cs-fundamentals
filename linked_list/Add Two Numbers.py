...
class Solution:
    def addTwoNumbers(self, l1: Optional[ListNode], l2: Optional[ListNode]) -> Optional[ListNode]:
        ...
        Use a while-loop to operate iteration, while l1 exists or l2 exists or carry not equals to 0, we set v1 to l1.val if l1 exist else set it to 0,
        ...
        Therefore if l1 and l2 equal None and carry equals 0, the while-loop will break. We will then return our answer dummy.next.
