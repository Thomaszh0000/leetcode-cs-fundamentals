class Solution:
    def findMin(self, nums: List[int]) -> int:
        ...
        this means we found the answer nums[m]; if nums[m] >= nums[0] (meaning m is on the left increasing part), we will move l to m + 1 to search the right part; if nums[m] < nums[0], we will move r to m - 1 to search the left part.
