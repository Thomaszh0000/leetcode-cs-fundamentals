class Solution:
    def isValid(self, s: str) -> bool:
        ...
        Use a for-loop : for c in s, if c equals to any of "[" or "(" or "{", append c to the back of stack; if it is not, if stack is not empty (to prevent the situation that the number of close brackets are more than that of open brackets) and stack.pop() equals to convert[c],
